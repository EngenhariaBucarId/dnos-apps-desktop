...
@media (prefers-reduced-motion:reduce){#dnos-abrindo .pulso,#dnos-abrindo .anel,#dnos-abrindo .agente img{animation:none}}`;
  ...
  window.__DNOS_DESKTOP__ = { versao: "0.6.2", meuChrome: true, gravador: true, roteiro: true, gravadorMac: !!window.__DNOS_GRAVADOR_MAC__ };
})();
"#;
...
(() => {
  ...
  window.__DNOS_DESKTOP__ = Object.assign({ versao: "0.6.2", meuChrome: true, gravador: true, roteiro: true }, window.__DNOS_DESKTOP__ || {}, { meuChrome: true, gravador: true, roteiro: true, gravadorMac: !!window.__DNOS_GRAVADOR_MAC__ });
